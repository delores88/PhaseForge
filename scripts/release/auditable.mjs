...
export function auditableDependencies(bytes){
  ...
  }else throw Error('Expected an actual PE or ELF backend');
  ...
  const value=JSON.parse(zlib.inflateSync(range(offset,size),{maxOutputLength:16*1024*1024}).toString('utf8'));
